...
//        Employee employee = employeeMapperImpl.toModel(requestDto);
//        employee.setSocialSecurityNumber("abc " + new Random().nextInt(1000));
//        return employeeMapperImpl.toDto(employeeRepository.save(employee));
//    }
//
//    @Override
//    public List<EmployeeDto> findAll() {
//        return employeeRepository.findAll().stream()
//                .map(employeeMapperImpl::toDto)
//                .toList();
//    }
//
//    @Override
...
//                );
//        return employeeMapperImpl.toDto(employee);
//    }
//
//    @Override
